        ...
        <div className="p-6 overflow-y-auto max-h-[70vh]">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full h-96 px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white font-mono text-sm"
              disabled={loading}
            />
          </div>
        </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            {mode === 'import' && (
              ...
              >
                ...
                <span>{loading ? 'Import 중...' : 'Import 실행'}</span>
              </button>
            )}
          </div>
        </div>
